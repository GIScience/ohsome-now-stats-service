CREATE TABLE IF NOT EXISTS int.all_stats_user_7
(
`changeset_id`        Int64,
...
INDEX all_stats_user_7_skip_ht_ix hashtags TYPE set(0) GRANULARITY 1,
INDEX all_stats_user_7_skip_cts_ix country_iso_a3 TYPE set(0) GRANULARITY 1
)
    ENGINE = MergeTree
    PRIMARY KEY (
        user_id,
