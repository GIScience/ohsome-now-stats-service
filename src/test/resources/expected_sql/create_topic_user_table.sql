CREATE TABLE IF NOT EXISTS int.topic_user_amenity_6
(
    ...
    INDEX topic_user_amenity_6_skip_ht_ix hashtags TYPE set(0) GRANULARITY 1,
    INDEX topic_user_amenity_6_skip_cts_ix country_iso_a3 TYPE set(0) GRANULARITY 1
)
    ENGINE = MergeTree
    PRIMARY KEY (
                 user_id,
