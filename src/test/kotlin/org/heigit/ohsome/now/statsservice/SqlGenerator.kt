...
class SqlGenerator {
    ...
    @Test
    fun `create stats user insert SQL for both stages`() {
        this.writeStatsUserInsertSQL("int")
        this.writeStatsUserInsertSQL("prod")
    }
...
//        .forEach(::writeTopicDeleteSql)
    ...
    private fun writeStatsUserInsertSQL(stage: String) {
        writeSqlToFile("INSERT", "stats_user", stage) {
            createStatsUserInsert(stage, currentStatsSchemaVersion)
        }
    }
    ...
    private fun createStatsMvDDL(stage: String, statsSchemaVersion: String) =
        comment() +
                ...
                createStatsMaterializedViewForUserTable(stage, statsSchemaVersion, fourHoursLater)


    private fun createStatsUserInsert(stage: String, statsSchemaVersion: String) =
        comment() +
                createStatsUserTableInsert(stage, statsSchemaVersion, fourHoursLater)
