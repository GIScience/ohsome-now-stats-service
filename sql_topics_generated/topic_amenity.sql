-- generated by org.heigit.ohsome.now.statsservice.TopicSqlGenerator at 2023-12-11T15:43:00.794583Z
...
FROM int.stats
WHERE
    changeset_timestamp > parseDateTimeBestEffort('2023-12-11T19:43:00Z')
    AND
    (
