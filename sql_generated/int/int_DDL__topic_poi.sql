-- generated by org.heigit.ohsome.now.statsservice.SqlGenerator at 2023-12-20T16:06:02.954730Z


CREATE TABLE IF NOT EXISTS int.topic_poi_2
(
...
CREATE MATERIALIZED VIEW int.mv__stats_2_to_topic_poi_2
TO int.topic_poi_2
AS SELECT
    `changeset_timestamp`,
    `hashtag`,
