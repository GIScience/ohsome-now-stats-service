-- generated by org.heigit.ohsome.now.statsservice.SqlGenerator at 2025-05-21T13:02:19.440631291Z
...
CREATE TABLE IF NOT EXISTS int.topic_user_poi_3
(
    `changeset_timestamp` DateTime('UTC'),
    `hashtags`            Array(String),
    `user_id`             Int32,
...
CREATE MATERIALIZED VIEW int.mv__topic_poi_3_to_topic_user_poi_3
TO int.topic_user_poi_3
AS SELECT 
    `changeset_timestamp`,
    `hashtags`,
    `user_id`,
