-- generated by org.heigit.ohsome.now.statsservice.SqlGenerator at 2023-12-20T15:45:02.856898Z


CREATE TABLE IF NOT EXISTS int.topic_financial_2
(
...
CREATE MATERIALIZED VIEW int.mv__stats_2_to_topic_financial_2
TO int.topic_financial_2
AS SELECT
    `changeset_timestamp`,
    `hashtag`,
    `user_id`,
