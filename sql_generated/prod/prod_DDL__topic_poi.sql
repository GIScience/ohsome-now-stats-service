-- generated by org.heigit.ohsome.now.statsservice.SqlGenerator at 2025-07-22T09:53:59.660483242Z


CREATE TABLE IF NOT EXISTS prod.topic_poi_3
(
    ...
    INDEX topic_poi_3_skip_cts_ix country_iso_a3 TYPE set(0) GRANULARITY 1
)
ENGINE = MergeTree
PRIMARY KEY (
    has_hashtags,
...
CREATE MATERIALIZED VIEW prod.mv__all_stats_3_to_topic_poi_3
TO prod.topic_poi_3
AS SELECT
    `changeset_timestamp`,
    `hashtags`,
...
CREATE TABLE IF NOT EXISTS prod.topic_user_poi_3
(
    `changeset_timestamp` DateTime('UTC'),
    `hashtags`            Array(String),
    `user_id`             Int32,
    ...
    `h3_r3`               Nullable(UInt64),
    `h3_r6`               Nullable(UInt64),
INDEX topic_user_poi_3_skip_ht_ix hashtags TYPE set(0) GRANULARITY 1,
INDEX topic_user_poi_3_skip_cts_ix country_iso_a3 TYPE set(0) GRANULARITY 1
)
ENGINE = MergeTree
PRIMARY KEY (
    user_id,
...
CREATE MATERIALIZED VIEW prod.mv__topic_poi_3_to_topic_user_poi_3
TO prod.topic_user_poi_3
AS SELECT 
    `changeset_timestamp`,
    `hashtags`,
    `user_id`,
