-- generated by org.heigit.ohsome.now.statsservice.SqlGenerator at 2025-07-22T09:53:59.752851272Z
...
CREATE TABLE IF NOT EXISTS prod.topic_user_waterway_3
(
    `changeset_timestamp` DateTime('UTC'),
    `hashtags`            Array(String),
    `user_id`             Int32,
...
CREATE MATERIALIZED VIEW prod.mv__topic_waterway_3_to_topic_user_waterway_3
TO prod.topic_user_waterway_3
AS SELECT 
    `changeset_timestamp`,
    `hashtags`,
    `user_id`,
