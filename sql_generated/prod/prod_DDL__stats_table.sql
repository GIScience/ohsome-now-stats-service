-- generated by org.heigit.ohsome.now.statsservice.SqlGenerator at 2025-05-14T10:29:20.213379079Z


-- main stats table definition
CREATE TABLE IF NOT EXISTS prod.all_stats_3
(
`changeset_id`        Int64,
...
INDEX all_stats_3_skip_ht_ix hashtags TYPE set(0) GRANULARITY 1,
INDEX all_stats_3_skip_user_id_ix user_id TYPE bloom_filter(0.25) GRANULARITY 1
)
ENGINE = MergeTree
PRIMARY KEY (
    has_hashtags,
